...
Because I want the model available and easy to use for everyone, I am also interested in implementing Kuzushiji recognition model with a mobile phone application. 

### Evo-Ukiyoe and Evo-Nishikie
Sakana AI Blog: [日本の美を学んだAI：浮世絵風画像生成モデルEvo-Ukiyoeと浮世絵カラー化モデルEvo-Nishikie](https://sakana.ai/evo-ukiyoe/)
The model learned from over 20,000 Ukiyoe art works belonged to Ritsumeikan University Art Research Center. Evo-Ukiyoe is an image generation model that learned from real Ukiyoe artworks. Evo-Nishikie to help colorized woodblock printed in books. This research aims to be used as an education tools to learn about Japanese rare book illustrations and Ukiyoe art.
...
## Invited Talks
1. Invited talk at the National Institute of Japanese Literature on "Large Language Models and Japanese Literature". (March 2024)
